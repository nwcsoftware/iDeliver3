-- fix35: Ensure the customer contact registration RPC exists for Supabase customer mobile auth.
-- Run this in Supabase SQL Editor if the schema does not yet have customer_contact_register_with_password.
